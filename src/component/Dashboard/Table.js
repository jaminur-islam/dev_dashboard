    ...
    >
      ...
      {/* Search Field  */}
       ...
       <Search className={classes.search_box}>
          ...
          <Button variant="outlined"  className={classes.export_btn}><SystemUpdateAltIcon></SystemUpdateAltIcon> Export Table</Button>
  ...
  .map((row, index) => {
    ...
    return (
      ...
      >
        ...
        <TableCell align="right"> <MoreVertIcon></MoreVertIcon> </TableCell>
